...
#filter(!ind%in%c("22","83", "131", "136", "159", "168", "267", "270")) # Cambiar por individuos ahogados
  
#FALTA REMOVER INDIVIDUOS AHOGADOS
...
oxall<-read.csv("./Outputs/oxygenall_aftercodedeletion.csv")
```
