...
** Make final result plots

* **For Activation energy:**

** Check for other data distribution
...
**For all**:
Write a summary of all the data processing
...
data3 %>%  ggplot(aes(x=invtemp, y=lnderiv))+geom_point()+geom_abline(intercept = intercept, slope = slope, color="red", 
