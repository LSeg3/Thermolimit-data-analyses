...
plottst
ggsave(plot=last_plot(),filename="Topt_stage_minustrial2and outliers.jpg",  path="Outputs/Statistics/", height=4.5, width=7.29, units="in")
...
ggsave(plot=last_plot(),filename="Ropt_stage_perstage_minustrial2andOutliers.jpg",  path="Outputs/Statistics/", height=4.5, width=7.29, units="in")
```
...
# Fig 1: TPC
fa<-readJPEG("Outputs/Statistics/TPC/sex1-noOutliers.jpeg")
fb<-readJPEG("Outputs/Statistics/TPC/Differences.jpg")
fc<-readJPEG("Outputs/Statistics/TPC/all-noOutliers.jpeg")
jpeg("Outputs/Statistics/Fig1.jpg", height=8, width=8, units="in", res=300)
par(mar=rep(0,4))
layout(matrix(c(1,2,3,3), ncol=2, byrow=TRUE), heights=c(0.4,0.6), widths=c(0.6, 0.4))
plot(NA,xlim=0:1,ylim=0:1,xaxt="n",yaxt="n",bty="n")
rasterImage(fa,0,0,1,1)
plot(NA,xlim=0:1,ylim=0:1,xaxt="n",yaxt="n",bty="n")
rasterImage(fb,0,0,1,1)
plot(NA,xlim=0:1,ylim=0:1,xaxt="n",yaxt="n",bty="n")
rasterImage(fc,0,0,1,1)
dev.off()




m1<-readJPEG("Outputs/Statistics/means_microenv.jpg")
m2<-readJPEG("Outputs/Statistics/maxs_microenv.jpg")
fs<-readJPEG("Outputs/Microclimate vs performance/Female_allseason_allarea_future.jpg")

library(graphics)
jpeg("Outputs/Statistics/Fig1.jpg", height=12, width=8, units="in", res=300)
par(mar=rep(0,4))
layout(matrix(c(1,2,3,3), ncol=2, byrow=TRUE), heights=c(0.2,0.8))
plot(NA,xlim=0:1,ylim=0:1,xaxt="n",yaxt="n",bty="n")
rasterImage(m1,0,0,1,1)
plot(NA,xlim=0:1,ylim=0:1,xaxt="n",yaxt="n",bty="n")
rasterImage(m2,0,0,1,1)
plot(NA,xlim=0:1,ylim=0:1,xaxt="n",yaxt="n",bty="n")
rasterImage(fs,0,0,1,1)
dev.off()


ggarrange(ggarrange(means, maxs, ncol=2, labels=c("A", "B"), common.legend = T , heights=c(1,2)), 
          fems, nrow=2,lables="C") %>% ggexport("Outputs/Statistics/fig2.jpg")
fig2
ggexport(plot=fig2,filename="fig3.jpg",  path="Outputs/Statistics/")


library("gridExtra")
library("cowplot")
gt <- arrangeGrob(means,maxs, # box plot and scatter plot
                  fems,# bar plot spaning two columns
             ncol = 2, nrow = 2, 
