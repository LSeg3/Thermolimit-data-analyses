...
p1
ggsave(plot=last_plot(),filename="Predictionplot1.jpg",  path="Outputs/Statistics/",width=7, height=7, units="in")
...
ggsave(plot=last_plot(),filename="Predictionplot2.jpg",  path="Outputs/Statistics/",width=7, height=7, units="in")
```
