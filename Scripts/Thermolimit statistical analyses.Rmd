...
I need to have the figure of the object "sex", "all" and "diffsplot" from the Script named "Plot.R", folder: Respirometry. 
```{r}
ggarrange(ggarrange(sex, diffsplot, ncol = 2, labels = c("A", "B")), # First row with box and dot plots
          all,
          nrow = 2, 
